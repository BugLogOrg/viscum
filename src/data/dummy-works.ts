...
const DUMMY_WORKS_RAW: Work[] = [
  {
    id: "viscum-self",
    title: "個人制作の速報棚に少額コンペを広告費としてばらまけるか——Viscum自体の初見レビュー募集。開催中バッジと金額、払う顔は伝わる？稼ぐ副業っぽく見えない？名前・色・初動の迷いを一言ください",
    tagline: "個人制作の速報棚に少額コンペを広告費としてばらまけるか——Viscum自体の初見レビュー募集。開催中バッジと金額、払う顔は伝わる？稼ぐ副業っぽく見えない？名前・色・初動の迷いを一言ください",
    seeder: "tori",
    tags: ["アプリ", "告知"],
    status: "open",
    ...
    featured: true,
    description:
      "個人が作ったアプリや動画を速報棚に載せて、少額のコメントコンペを広告費としてばらまけるか——Viscum（ヤドリギ候補）自体の初見レビュー募集。開催中バッジと金額、払う顔は伝わる？稼ぐ副業っぽく見えない？名前・色・初動の迷いを一言ください。厳しめで短くて大丈夫です。\n\n個人制作物の速報棚＋任意コンペの装置です。初見で迷いやすいところを、聞くこと（足場）に沿って一言ください。",
  ...
  },
  {
    ...
    hoursAgo: 9,
    closesInHours: 72,
    description: "短編『団地の屋上』のあらすじと冒頭800字だけ公開します。続きが読みたくなる温度感か、一人目の印象は残るか。全文ではなく入口だけのレビュー募集です。タイトル案や刺さった一文、あらすじの長さの負荷感も大歓迎。小説タグのメンター向けコンペなので、厳しめでお願いします。\n\n全文ではなく冒頭のみ。改善提案の聞くこと（足場）に沿って。",
  ...
  {
    id: "idle-game",
    title: "放置系『苔を育てる』を無料公開。コンペなしで感想とお礼だけ。最初の成長が遅すぎて離脱しないか、待つ楽しさは伝わるか。報酬粒度やチュートリアル後の空白感など具体FBを",
    tagline: "放置系『苔を育てる』を無料公開。コンペなしで感想とお礼だけ。最初の成長が遅すぎて離脱しないか、待つ楽しさは伝わるか。報酬粒度やチュートリアル後の空白感など具体FBを",
    seeder: "moss",
    tags: ["ゲーム"],
    status: "open",
    plan: "free_comment",
    hoursAgo: 14,
    closesInHours: 36,
    description: "放置系『苔を育てる』を無料公開しています。コンペなしで感想とお礼だけで回すテストです。最初の成長が遅すぎて離脱しないか、待つ楽しさは伝わるか。ゲームとして成立しているかのラフなフィードバックをください。報酬の粒度やチュートリアル後の空白感など、具体があると助かります。\n\nコンペなし。お礼と選出だけで回すテスト。",
  ...
  {
    id: "podcast-cover",
    title: "ポッドキャスト封面の大喜利コンペ。真面目な添削よりタイトル案・一言ツッコミ・サムネ第一印象を。クリックしたくなる顔か。色・フォント・余白の違和感も短く尖った案歓迎です",
    tagline: "ポッドキャスト封面の大喜利コンペ。真面目な添削よりタイトル案・一言ツッコミ・サムネ第一印象を。クリックしたくなる顔か。色・フォント・余白の違和感も短く尖った案歓迎です",
    seeder: "wave",
    tags: ["音声", "大喜利"],
    status: "open",
    plan: "first_impression",
    ...
    hoursAgo: 22,
    closesInHours: 12,
    description: "ポッドキャスト封面の大喜利コンペです。真面目な添削より、タイトル案・一言ツッコミ・サムネの第一印象をください。音声番組の顔としてクリックしたくなるか。短くて尖った案ほど選出しやすいです。初見レビュー帯の軽量祭りなので気軽に。色・フォント・余白の違和感の指摘も歓迎しています。\n\n真面目な添削よりタイトル・一言ツッコミ歓迎。",
  ...
  {
    id: "closed-one",
    title: "先週終了したUI壁打ちコンペのアーカイブ見本。選出→褒賞支払い完了後の見え方チェック用。終わった祭りの棚残り、選出バッジと支払い済みの見つけやすさ、メンター出金導線を見てほしい",
    tagline: "先週終了したUI壁打ちコンペのアーカイブ見本。選出→褒賞支払い完了後の見え方チェック用。終わった祭りの棚残り、選出バッジと支払い済みの見つけやすさ、メンター出金導線を見てほしい",
    seeder: "neo",
    tags: ["アプリ"],
    status: "closed",
    plan: "first_impression",
    ...
    paymentsDone: 1,
    description:
      "先週終了したUI壁打ちコンペのアーカイブ見本です。選出→褒賞支払い完了まで終わったあとの見え方チェック用。新規は受け付けない想定なので、閲覧時に迷わないかだけ見てください。終わった祭りの棚残り方、選出バッジと支払い済みの見つけやすさ、メンターの出金導線の有無も見てほしいです。\n\n終了＋支払い完了の見本。選出コメントに褒賞支払い済みと、メンター向け「受け取る」導線（デモ）が付きます。",
  ...
  {
    id: "recipe-site",
    title: "一人暮らし向け5分レシピ棚の公開（コンペなし）。検索せずにTonightの一皿が出るか、写真と手順の密度はスマホで辛くないか。情報過多／不足、材料単位、献立の決断コストも教えて",
    tagline: "一人暮らし向け5分レシピ棚の公開（コンペなし）。検索せずにTonightの一皿が出るか、写真と手順の密度はスマホで辛くないか。情報過多／不足、材料単位、献立の決断コストも教えて",
    seeder: "nabe",
    tags: ["Web"],
    status: "open",
    plan: "free_comment",
    hoursAgo: 11,
    closesInHours: 20,
    description: "一人暮らし向け5分レシピ棚の公開（コンペなし）です。検索せずにTonightの一皿が出るか、写真と手順の密度はスマホで辛くないか。感想コメント歓迎。料理サイトでありがちな情報過多／不足のどちらに寄っているか、材料の単位の分かりやすさ、献立の決断コストも教えてください。\n\nコンペなしの公開。感想歓迎。",
  ...
  {
    id: "landing-ab",
    title: "LPヒーロー文案A/B、どっちが「払う気」になるか選んで理由を件名に。個人プロダクトの少額コンペ誘導用。煽りすぎず弱すぎない境界。企業LPっぽさ・禁止語感も。スクショ2案で一票を",
    tagline: "LPヒーロー文案A/B、どっちが「払う気」になるか選んで理由を件名に。個人プロダクトの少額コンペ誘導用。煽りすぎず弱すぎない境界。企業LPっぽさ・禁止語感も。スクショ2案で一票を",
    seeder: "abo",
    tags: ["Web", "告知"],
    status: "open",
    plan: "brush_up",
    ...
    hoursAgo: 2,
    closesInHours: 14,
    description: "LPヒーロー文案A/Bのどちらが「払う気」になるか選んで、理由を件名に書いてください。個人プロダクトの少額コンペ誘導用です。煽りすぎず、でも弱いと消える——その境界のレビューが欲しいです。スクショ2案を見比べて一票を。禁止語感や企業LPっぽさの指摘も大歓迎しています。\n\n2案のスクショ。改善提案の聞くことに沿って、どちらを選ぶかも本文で。",
    externalUrl: "https://example.com/lp",
    thumbTone: "bark",
    comments: [
      {
  ...
  {
    id: "icon-set",
    title: "アプリアイコン案4種の識別チェック（コンペなし）。小さいサイズでも何のアプリか分かるか、ヤドリギっぽさと汎用の間でどれが強いか。ホーム画面に並んだ想像で一言。潰れる案も教えて",
    tagline: "アプリアイコン案4種の識別チェック（コンペなし）。小さいサイズでも何のアプリか分かるか、ヤドリギっぽさと汎用の間でどれが強いか。ホーム画面に並んだ想像で一言。潰れる案も教えて",
    seeder: "ico",
    tags: ["デザイン"],
    status: "open",
    plan: "free_comment",
