...
const DUMMY_WORKS_RAW: Work[] = [
  ...
  {
    id: "closed-one",
    title: "先週終了したUI壁打ちコンペのアーカイブ見本。採用→支払い完了後の見え方チェック用。終わった祭りの棚残り、採用バッジと支払い済みの見つけやすさ、メンター出金導線を見てほしい",
    tagline: "先週終了したUI壁打ちコンペのアーカイブ見本。採用→支払い完了後の見え方チェック用。終わった祭りの棚残り、採用バッジと支払い済みの見つけやすさ、メンター出金導線を見てほしい",
    seeder: "neo",
    tags: ["アプリ"],
    status: "closed",
    plan: "first_impression",
    ...
    paymentsDone: 1,
    description:
      "先週終了したUI壁打ちコンペのアーカイブ見本です。採用→支払い完了まで終わったあとの見え方チェック用。新規は受け付けない想定なので、閲覧時に迷わないかだけ見てください。終わった祭りの棚残り方、採用バッジと支払い済みの見つけやすさ、メンターの出金導線の有無も見てほしいです。\n\n終了＋支払い完了の見本。採用コメントにチップ支払い済みと、メンター向け「受け取る」導線（デモ）が付きます。",
  ...
  {
    id: "pay-after-adopt",
    title: "採用した直後・Checkout前の見本。採用マークはあるがチップ未払いの中間状態が分かるか確認して。文言が怖くないか、金額の再確認が足りるか、メンターに出金リンクが出ない想定も",
    tagline: "採用した直後・Checkout前の見本。採用マークはあるがチップ未払いの中間状態が分かるか確認して。文言が怖くないか、金額の再確認が足りるか、メンターに出金リンクが出ない想定も",
    seeder: "tori",
    tags: ["アプリ", "決済"],
    status: "open",
    plan: "first_impression",
    ...
    featured: true,
    description:
      "採用した直後・Checkout前の見本です。決済準備中を越えて、シーダーが『採用して支払う』を押す直前の画面。メンターにはまだ出金リンクが出ない想定。採用マークは付いているがチップ未払い、という中間状態が分かるか確認してください。文言が怖くないか、金額の再確認が足りるかも見てほしいです。\n\n決済準備中の先＝採用時支払いの直前。コメントは採用済みだが、まだ Checkout していない状態のデモです。",
