...
const DUMMY_WORKS_RAW: Work[] = [
  {
    id: "viscum-self",
    title: "個人制作の速報棚に少額のお願いを広告費としてばらまけるか——Viscum自体の初見レビュー募集。開催中バッジと金額、払う顔は伝わる？稼ぐ副業っぽく見えない？名前・色・初動の迷いを一言ください",
    tagline: "個人制作の速報棚に少額のお願いを広告費としてばらまけるか——Viscum自体の初見レビュー募集。開催中バッジと金額、払う顔は伝わる？稼ぐ副業っぽく見えない？名前・色・初動の迷いを一言ください",
    seeder: "tori",
    tags: ["アプリ", "告知"],
    status: "open",
    ...
    featured: true,
    description:
      "個人が作ったアプリや動画を速報棚に載せて、少額のお願いを広告費としてばらまけるか——Viscum（ヤドリギ候補）自体の初見レビュー募集。開催中バッジと金額、払う顔は伝わる？稼ぐ副業っぽく見えない？名前・色・初動の迷いを一言ください。厳しめで短くて大丈夫です。\n\n個人制作物の速報棚＋任意のお願いの装置です。初見で迷いやすいところを、聞くこと（足場）に沿って一言ください。",
  ...
  {
    id: "note-clip",
    title: "起床すぐ三行だけ書くメモアプリβの初見レビュー。起動直後の空白・通知のうざさ・ウィジェットで何のアプリか3秒で分かるか。優しすぎ／指図がましい境界も教えてください",
    tagline: "起床すぐ三行だけ書くメモアプリβの初見レビュー。起動直後の空白・通知のうざさ・ウィジェットで何のアプリか3秒で分かるか。優しすぎ／指図がましい境界も教えてください",
    seeder: "ayu",
    tags: ["アプリ"],
    status: "open",
    plan: "first_impression",
    ...
    hoursAgo: 4,
    closesInHours: 20,
    description: "朝起きてすぐ三行だけ書けばいいメモアプリのβです。書くハードルを下げたいのに起動直後が空白だと迷うので、オンボーディングと通知のうざさ、ウィジェットの初見を見てほしいレビュー募集。何のアプリか3秒で分かるか、優しすぎ／指図がましいの境界も教えてください。\n\n起床後3行だけ書くメモ。通知とウィジェットの初見を見てほしい。",
  ...
  {
    id: "promo-15s",
    title: "宅配ボックスIoTの15秒プロモ（Shorts想定）。冒頭1秒で何の製品か、音なしでも伝わるか。掴みとテロップ密度、広告っぽさ／地味さ、ブランド名の出し方を見てほしいです",
    tagline: "宅配ボックスIoTの15秒プロモ（Shorts想定）。冒頭1秒で何の製品か、音なしでも伝わるか。掴みとテロップ密度、広告っぽさ／地味さ、ブランド名の出し方を見てほしいです",
    seeder: "ken",
    tags: ["動画"],
    status: "open",
    plan: "first_impression",
    ...
    hoursAgo: 6,
    closesInHours: 8,
    description: "宅配ボックスIoTの15秒プロモ（YouTube Shorts想定）。冒頭1秒で何の製品か分かるか、音なしでも伝わるかだけ見てほしいです。フル尺は不要で、最初の15秒の掴みとテロップの密度にコメントください。広告っぽすぎ／地味すぎ、ブランド名の出し方の指摘も大歓迎です。\n\nYouTube Shorts用。見る範囲は冒頭15秒だけでOK。聞くこと（足場）に沿って短く。",
  ...
  {
    id: "novel-open",
    title: "短編『団地の屋上』あらすじ＋冒頭800字の改善提案。続きが読みたくなる温度か、一人目の印象は残るか。タイトル案・刺さった一文・あらすじの長さの負荷感も大歓迎です",
    tagline: "短編『団地の屋上』あらすじ＋冒頭800字の改善提案。続きが読みたくなる温度か、一人目の印象は残るか。タイトル案・刺さった一文・あらすじの長さの負荷感も大歓迎です",
    seeder: "sana",
    tags: ["小説", "短編", "冒頭"],
    status: "open",
    plan: "brush_up",
    ...
    hoursAgo: 9,
    closesInHours: 72,
    description: "短編『団地の屋上』のあらすじと冒頭800字だけ公開します。続きが読みたくなる温度感か、一人目の印象は残るか。全文ではなく入口だけのレビュー募集です。タイトル案や刺さった一文、あらすじの長さの負荷感も大歓迎。小説タグのメンター向けのお願いなので、厳しめでお願いします。\n\n全文ではなく冒頭のみ。改善提案の聞くこと（足場）に沿って。",
  ...
  {
    id: "lp-saas",
    title: "B2B請求書SaaSのランディング初見チェック。誰向けか3秒で分かるか、ヒーロー文とCTAは営業っぽすぎないか。ターゲット誤解・専門用語の壁・次に押すボタンの位置を指摘して",
    tagline: "B2B請求書SaaSのランディング初見チェック。誰向けか3秒で分かるか、ヒーロー文とCTAは営業っぽすぎないか。ターゲット誤解・専門用語の壁・次に押すボタンの位置を指摘して",
    seeder: "rio",
    tags: ["アプリ", "LP"],
    status: "pay_soon",
    plan: "first_impression",
  ...
  {
    id: "idle-game",
    title: "放置系『苔を育てる』を無料公開。褒賞なしで感想とお礼だけ。最初の成長が遅すぎて離脱しないか、待つ楽しさは伝わるか。報酬粒度やチュートリアル後の空白感など具体FBを",
    tagline: "放置系『苔を育てる』を無料公開。褒賞なしで感想とお礼だけ。最初の成長が遅すぎて離脱しないか、待つ楽しさは伝わるか。報酬粒度やチュートリアル後の空白感など具体FBを",
    seeder: "moss",
    tags: ["ゲーム"],
    status: "open",
    plan: "free_comment",
    hoursAgo: 14,
    closesInHours: 36,
    description: "放置系『苔を育てる』を無料公開しています。褒賞なしで感想とお礼だけで回すテストです。最初の成長が遅すぎて離脱しないか、待つ楽しさは伝わるか。ゲームとして成立しているかのラフなフィードバックをください。報酬の粒度やチュートリアル後の空白感など、具体があると助かります。\n\n褒賞なし。お礼と選出だけで回すテスト。",
    ...
    comments: [
      {
        ...
        body: "チュートリアル後、次の変化まで待ち時間が長く、『待つ楽しさ』が言語化されていませんでした。最初の5分で小さな花が咲くなど、報酬の粒度を細かくすると放置ゲーの快感に乗れると思います。褒賞なしでもお礼だけもらえる空気は良いです。",
        attitude: "red",
        hoursAgo: 6,
      },
      {
        ...
        author: "放置SS",
        subject: "お礼だけの空気は良い",
        body: "褒賞なしでも感想が書ける場として賛成です。報酬粒度だけ直せば回ります。",
        attitude: "blue",
        hoursAgo: 3,
      },
      {
  ...
  {
    id: "chrome-ext",
    title: "タブをヤドリギみたいに束ねるChrome拡張の初動レビュー。インストール〜最初のグループ作成まで。権限説明は怖くないか、グループ名UIは迷わないか。ストア文面・アイコンも一言",
    tagline: "タブをヤドリギみたいに束ねるChrome拡張の初動レビュー。インストール〜最初のグループ作成まで。権限説明は怖くないか、グループ名UIは迷わないか。ストア文面・アイコンも一言",
    seeder: "tab",
    tags: ["アプリ"],
    status: "open",
    plan: "first_impression",
    ...
    hoursAgo: 18,
    closesInHours: 54,
    description: "タブをヤドリギみたいに束ねるChrome拡張の初動レビュー募集です。インストールから最初のグループ作成まで見てほしい。権限説明は怖くないか、グループ名の付け方UIは迷わないか。ストア文面の印象、アイコンの識別性、やり直しのしやすさも一言もらえると助かります。短文歓迎です。\n\nChrome拡張。インストール〜最初のグループ作成まで。",
  ...
  {
    id: "podcast-cover",
    title: "ポッドキャスト封面の大喜利。真面目な添削よりタイトル案・一言ツッコミ・サムネ第一印象を。クリックしたくなる顔か。色・フォント・余白の違和感も短く尖った案歓迎です",
    tagline: "ポッドキャスト封面の大喜利。真面目な添削よりタイトル案・一言ツッコミ・サムネ第一印象を。クリックしたくなる顔か。色・フォント・余白の違和感も短く尖った案歓迎です",
    seeder: "wave",
    tags: ["音声", "大喜利"],
    status: "open",
    plan: "first_impression",
    ...
    hoursAgo: 22,
    closesInHours: 12,
    description: "ポッドキャスト封面の大喜利です。真面目な添削より、タイトル案・一言ツッコミ・サムネの第一印象をください。音声番組の顔としてクリックしたくなるか。短くて尖った案ほど選出しやすいです。初見レビュー帯の軽量祭りなので気軽に。色・フォント・余白の違和感の指摘も歓迎しています。\n\n真面目な添削よりタイトル・一言ツッコミ歓迎。",
  ...
  {
    id: "closed-one",
    title: "先週終了したUI壁打ちのお願いのアーカイブ見本。選出→褒賞支払い完了後の見え方チェック用。終わった祭りの棚残り、選出バッジと支払い済みの見つけやすさ、メンター出金導線を見てほしい",
    tagline: "先週終了したUI壁打ちのお願いのアーカイブ見本。選出→褒賞支払い完了後の見え方チェック用。終わった祭りの棚残り、選出バッジと支払い済みの見つけやすさ、メンター出金導線を見てほしい",
    seeder: "neo",
    tags: ["アプリ"],
    status: "closed",
    plan: "first_impression",
    ...
    paymentsDone: 1,
    description:
      "先週終了したUI壁打ちのお願いのアーカイブ見本です。選出→褒賞支払い完了まで終わったあとの見え方チェック用。新規は受け付けない想定なので、閲覧時に迷わないかだけ見てください。終わった祭りの棚残り方、選出バッジと支払い済みの見つけやすさ、メンターの出金導線の有無も見てほしいです。\n\n終了＋支払い完了の見本。選出コメントに褒賞支払い済みと、メンター向け「受け取る」導線（デモ）が付きます。",
  ...
  {
    id: "pay-after-adopt",
    title: "選出した直後・Checkout前の見本。選出マークはあるが褒賞未払いの中間状態が分かるか確認して。文言が怖くないか、金額の再確認が足りるか、メンターに出金リンクが出ない想定も",
    tagline: "選出した直後・Checkout前の見本。選出マークはあるが褒賞未払いの中間状態が分かるか確認して。文言が怖くないか、金額の再確認が足りるか、メンターに出金リンクが出ない想定も",
    seeder: "tori",
    tags: ["アプリ", "決済"],
    status: "open",
    plan: "first_impression",
    ...
    featured: true,
    description:
      "選出した直後・Checkout前の見本です。決済準備中を越えて、シーダーが『褒賞を渡す』を押す直前の画面。メンターにはまだ出金リンクが出ない想定。選出マークは付いているが褒賞未払い、という中間状態が分かるか確認してください。文言が怖くないか、金額の再確認が足りるかも見てほしいです。\n\n決済準備中の先＝選出時支払いの直前。コメントは選出済みだが、まだ Checkout していない状態のデモです。",
    ...
    comments: [
      {
        ...
        body: "ヒーローは伝わります。起動直後の空白だけが不安なので、昨日の続きかプレースホルダがあると良いです。選出してもらえたら嬉しいですが、支払いはシーダー判断でOKです。",
        attitude: "blue",
        hoursAgo: 3,
        adopted: true,
      },
  ...
  {
    id: "figma-proto",
    title: "予約フローのFigmaクリックプロト。スマホ親指ゾーンで最初の3タップまで見てほしい。戻る・次へ・日付選択の迷いを。美しさより到達のしやすさ。指が届かない／一段深い指摘大歓迎",
    tagline: "予約フローのFigmaクリックプロト。スマホ親指ゾーンで最初の3タップまで見てほしい。戻る・次へ・日付選択の迷いを。美しさより到達のしやすさ。指が届かない／一段深い指摘大歓迎",
    seeder: "yuki",
    tags: ["デザイン"],
    status: "open",
    plan: "first_impression",
  ...
  {
    id: "cli-tool",
    title: "READMEとgifだけ見てもらうCLIドキュメントの初見レビュー。install前の期待値は合うか、何をするコマンドか怖そうに見えないか。専門用語の壁・デモ長さ・コピーの安心感を初心者目線で",
    tagline: "READMEとgifだけ見てもらうCLIドキュメントの初見レビュー。install前の期待値は合うか、何をするコマンドか怖そうに見えないか。専門用語の壁・デモ長さ・コピーの安心感を初心者目線で",
    seeder: "dev",
    tags: ["ツール"],
    status: "open",
    plan: "first_impression",
  ...
  {
    id: "recipe-site",
    title: "一人暮らし向け5分レシピ棚の公開（褒賞なし）。検索せずにTonightの一皿が出るか、写真と手順の密度はスマホで辛くないか。情報過多／不足、材料単位、献立の決断コストも教えて",
    tagline: "一人暮らし向け5分レシピ棚の公開（褒賞なし）。検索せずにTonightの一皿が出るか、写真と手順の密度はスマホで辛くないか。情報過多／不足、材料単位、献立の決断コストも教えて",
    seeder: "nabe",
    tags: ["Web"],
    status: "open",
    plan: "free_comment",
    hoursAgo: 11,
    closesInHours: 20,
    description: "一人暮らし向け5分レシピ棚の公開（褒賞なし）です。検索せずにTonightの一皿が出るか、写真と手順の密度はスマホで辛くないか。感想コメント歓迎。料理サイトでありがちな情報過多／不足のどちらに寄っているか、材料の単位の分かりやすさ、献立の決断コストも教えてください。\n\n褒賞なしの公開。感想歓迎。",
  ...
  {
    id: "pitch-deck",
    title: "1枚ピッチPDFの視線誘導レビュー。最初の3秒で何のサービスか伝わるか、次に何をしてほしいかが分かるか。個人開発の仲間向けトーン。誤解ポイントと目線の止まる場所を件名に書いて",
    tagline: "1枚ピッチPDFの視線誘導レビュー。最初の3秒で何のサービスか伝わるか、次に何をしてほしいかが分かるか。個人開発の仲間向けトーン。誤解ポイントと目線の止まる場所を件名に書いて",
    seeder: "kai",
    tags: ["デザイン"],
    status: "open",
    plan: "first_impression",
  ...
  {
    id: "podcast-op",
    title: "ポッドキャストOP30秒の掴みチェック。スキップされない導入か、トーンは親しすぎ／堅すぎないか。自己紹介の長さと本題への入り方、BGMの大きさ・間の違和感を厳しめで短くください",
    tagline: "ポッドキャストOP30秒の掴みチェック。スキップされない導入か、トーンは親しすぎ／堅すぎないか。自己紹介の長さと本題への入り方、BGMの大きさ・間の違和感を厳しめで短くください",
    seeder: "rim",
    tags: ["動画"],
    status: "open",
    plan: "brush_up",
  ...
  {
    id: "chrome-ext-store",
    title: "タブ整理Chrome拡張の公開ブースト。ストア／Xへ正直な反応を残し投稿URLを報告。権限ダイアログは怖くないか、何が片付く拡張か。実利用のうえで。星の指定・やらせは不可です",
    tagline: "タブ整理Chrome拡張の公開ブースト。ストア／Xへ正直な反応を残し投稿URLを報告。権限ダイアログは怖くないか、何が片付く拡張か。実利用のうえで。星の指定・やらせは不可です",
    seeder: "ext",
    tags: ["ツール", "アプリ"],
    status: "open",
    plan: "public_boost",
  ...
  {
    id: "short-story",
    title: "掌編『バス停の傘』約2000字のレビュー。結末の余韻の切れ方だけ重点的に。最後の一文は残るか、タイトルと結末の対応は。ネタバレを件名に書いてOK。長さの負荷と読み直したいかも一言",
    tagline: "掌編『バス停の傘』約2000字のレビュー。結末の余韻の切れ方だけ重点的に。最後の一文は残るか、タイトルと結末の対応は。ネタバレを件名に書いてOK。長さの負荷と読み直したいかも一言",
    seeder: "umi",
    tags: ["小説"],
    status: "open",
    plan: "brush_up",
    ...
    hoursAgo: 14,
    closesInHours: 60,
    description: "掌編『バス停の傘』約2000字のレビュー募集です。結末の余韻の切れ方だけ重点的に見てほしい。途中の描写より、最後の一文が残るか。タイトルと結末の対応も気になっています。ネタバレを件名に書いても大丈夫です。長さの負荷感と、読み直ししたいかどうかも一言ください。小説メンター向け・改善提案帯。\n\n2000字。結末の一言だけ見てほしい。改善提案の聞くことに沿って。",
  ...
  {
    id: "landing-ab",
    title: "LPヒーロー文案A/B、どっちが「払う気」になるか選んで理由を件名に。個人プロダクトの少額のお願い誘導用。煽りすぎず弱すぎない境界。企業LPっぽさ・禁止語感も。スクショ2案で一票を",
    tagline: "LPヒーロー文案A/B、どっちが「払う気」になるか選んで理由を件名に。個人プロダクトの少額のお願い誘導用。煽りすぎず弱すぎない境界。企業LPっぽさ・禁止語感も。スクショ2案で一票を",
    seeder: "abo",
    tags: ["Web", "告知"],
    status: "open",
    plan: "brush_up",
    ...
    hoursAgo: 2,
    closesInHours: 14,
    description: "LPヒーロー文案A/Bのどちらが「払う気」になるか選んで、理由を件名に書いてください。個人プロダクトの少額のお願い誘導用です。煽りすぎず、でも弱いと消える——その境界のレビューが欲しいです。スクショ2案を見比べて一票を。禁止語感や企業LPっぽさの指摘も大歓迎しています。\n\n2案のスクショ。改善提案の聞くことに沿って、どちらを選ぶかも本文で。",
    externalUrl: "https://example.com/lp",
    thumbTone: "bark",
    comments: [
      {
  ...
  {
    id: "icon-set",
    title: "アプリアイコン案4種の識別チェック（褒賞なし）。小さいサイズでも何のアプリか分かるか、ヤドリギっぽさと汎用の間でどれが強いか。ホーム画面に並んだ想像で一言。潰れる案も教えて",
    tagline: "アプリアイコン案4種の識別チェック（褒賞なし）。小さいサイズでも何のアプリか分かるか、ヤドリギっぽさと汎用の間でどれが強いか。ホーム画面に並んだ想像で一言。潰れる案も教えて",
    seeder: "ico",
    tags: ["デザイン"],
    status: "open",
    plan: "free_comment",
    hoursAgo: 20,
    closesInHours: 96,
    description: "アプリアイコン案4種の識別チェック（褒賞なし）です。小さいサイズでも何のアプリか分かるか、ヤドリギっぽさと汎用アイコンの間でどれが強いか。好き嫌いベースで大丈夫です。ホーム画面に並んだ想像での一言コメント歓迎。似て見える組や、潰れて読めない案があれば教えてください。\n\n褒賞なし。好き嫌いコメント歓迎。",
