      ...
      <section className="border-b border-viscum-line px-4 py-5">
        ...
        <details className="mt-2 max-w-lg group">
          ...
          <p className="mt-1.5 text-[11px] leading-snug text-viscum-muted">
            どちらもスコアや順位ではありません。シーダー側は決済完了の件数と金額、メンター側の参加作品はコメントした時点の事実です（選出・褒賞は別途）。直依頼の中身・相手一覧はここに出しません。メンターの累計受取は「いくら稼いだ自慢」ではなく、ちゃんと払われた透明性のための表示です。お願いで選ばれた反応は既定で公開されます。
          </p>
        </details>
      </section>
