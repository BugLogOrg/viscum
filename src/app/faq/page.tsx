...
export const metadata: Metadata = {
  title: "よくある質問",
  description:
    "なぜこういう場が要るか、シード棚と直依頼のちがい、プロフィール公開範囲、手数料約10%、他サービスやサクラとの違い、荒れにくさのインセンティブ。",
};
    ...
    body: (
      <>
        ...
        <p>
          ...
          … 源泉徴収や所得申告は、依頼主・受取側で各自確認してください。VISCUMは源泉の代行・預かりはしません。「約10%」は場の手数料（決済込み）であり、税金の内訳ではありません。
        </p>
      </>
    ),
  },
