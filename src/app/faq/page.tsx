...
export const metadata: Metadata = {
  title: "よくある質問",
  description:
    "なぜこういう場が要るか、シード棚と直依頼のちがい、プロフィール公開範囲、手数料10%＋決済実費、ピン（有料掲載）、他サービスやサクラとの違い、荒れにくさのインセンティブ。",
};
    ...
    body: (
      <>
        <p>
          有料で完了払いするときのシーダー負担は、
          <span className="font-medium">
            褒賞（メンター向け額面）＋場の手数料10%＋決済手数料（実費）
          </span>
          です。例: 褒賞¥5,000なら、場の手数料¥500、決済手数料 約¥206、合計 約¥5,706。メンターに見える額面からは引きません。無料（¥0）のときは上乗せもありません。
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <span className="font-medium">場の手数料は褒賞の10%</span>
            … Viscum の運営手数料。ここだけが運営の取り分です。
          </li>
          <li>
            <span className="font-medium">決済手数料は実費（約3.6%）</span>
            … カード決済会社（Stripe）の料率を、総額に対してそのまま転嫁します。運営は受け取りません。料率が変われば表示も変えます。
          </li>
          <li>
        ...
        <p>
          決済画面（Stripe Checkout）には「褒賞／場の手数料／決済手数料」の3行と合計が並びます。払う前に総額が見えない、ということはありません。
        </p>
        <p>
          <span className="font-medium">税・源泉について</span>
          … 源泉徴収や所得申告は、依頼主・受取側で各自確認してください。VISCUMは源泉の代行・預かりはしません。「10%」は場の手数料であり、税金の内訳ではありません。
        </p>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <span className="font-medium">「注目」とは別枠</span>
            … 反応で自然に浮かぶ「注目」には混ぜません。ピン枠には「有料掲載」と小さく書きます。
          </li>
          <li>
            <span className="font-medium">売っているのは場所だけ</span>
            … コメント数・褒賞の選ばれやすさ・評価には一切関係しません。
          </li>
          <li>
            <span className="font-medium">満席なら待つ</span>
            … 3本埋まっているときは「次の空き」の時刻だけ出ます。競り上げ・順番待ちはありません。
          </li>
          <li>
        ...
        <p>
          支払いの直前に枠が埋まってしまった場合だけ、自動で全額返金します。
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          通報やNGワードの壁を厚くするより先に、
          <span className="font-medium">評価権の置き方</span>
          で濾しています。
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
          ...
          <li>
            厳しい指摘そのものは歓迎。選ばれる一言が燃料になる設計です
          </li>
          <li>
            直依頼の受け手は受付ON/OFFや頻度で守る（スパム化しない）
          </li>
        </ul>
        <p>
          「絶対に荒れない」保証ではありません。モデレーション機能で封じる場ではなく、
          <span className="font-medium">インセンティブで荒れにくくする場</span>
          です。詳細は「素人コメントばかりにならない？」も近い話です。
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          「ほしい答えだけ強制」はしません。ズレた声も、次のシードの材料になります。コメントにはログインが必要ですが、口座登録は褒賞を受け取るときまで不要です。
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            終わったあともコメントは書けるが、締切後の投稿は画面上で賞金対象外と明示されます
          </li>
        </ul>
        <p>
    ...
    body: (
      <>
        ...
        <p>
          ...
          でも、プロフィールに傷やペナルティは付きません。公開の看板は支払い完了の件数と合計だけです。一方的に届いた依頼を無視してよい、という意味でもあります。
        </p>
      </>
    ),
  },
      ...
      <>
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            … 出金用の Stripe（Connect 等）登録は、
            <span className="font-medium">口座に振り出してもらうとき</span>
            で大丈夫です。コメントしただけでは求めません。褒賞に選ばれた直後にすぐ登録する必要もありません（下の「入金と受け取り」参照）。
          </li>
        </ul>
        <p>
          シーダーが払う総額は「褒賞＋場の手数料10%＋決済手数料（実費）」です（上の「手数料はいくつ？」）。決済画面に3行で内訳と合計が出ます。いまはデモ段階のため、決済画面まで進んでも本番送金が完了しない・仮データが混ざる場合があります。本番接続後も、「払うとき／受け取るとき」に初めて Stripe の画面が出る、という切り方を維持します。
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <ol className="list-decimal space-y-2 pl-5">
          <li>
            シーダーが「褒賞を渡す」などで
            <span className="font-medium">Checkout（カード決済）を完了</span>
            する
          </li>
          <li>
            お金はいったん
            <span className="font-medium">VISCUM側（Stripe上）にプール</span>
            される。メンターがまだ口座登録していなくても消えない（7日で失効、という縛りは設けていない）
          </li>
          <li>
            メンターは都合のよいときに口座（Connect）を登録して、受け取り手続きに進む
          </li>
        </ol>
        <p>
          <span className="font-medium">プロフィールの実績（件数・累計）</span>
          は、口座への着金を待たず、
          <span className="font-medium">シーダーの入金が完了した時点</span>
          で増えます。シーダー側は「ちゃんと払った」、メンター側は「ちゃんと払われた」という事実の看板です。「選出だけ・未払い」では増えません。
        </p>
        <p>
          褒賞に選ばれたのにすぐ口座登録しない人は多い想定です。それで構いません。プールされたまま待っておき、受け取りたいときに登録すれば大丈夫、という設計です。なおメンターへの Connect 出金そのものは段階的に配線中で、デモでは入金まで／表示上の流れの確認が主になることがあります（「いま使って大丈夫？」も参照）。
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p>
          決済は Stripe を使う想定ですが、本番の引き落とし・振込が常に動いているとは限りません。流れの説明は上の「届いてから払うまで」「Stripeの登録」「褒賞の入金と受け取り」を見てください。
        </p>
      </>
    ),
  },
