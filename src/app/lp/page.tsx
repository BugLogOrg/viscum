    ...
    <div className="min-h-dvh bg-viscum-paper text-viscum-ink">
      ...
      <main className="mx-auto max-w-3xl px-6 py-14 sm:px-10">
        ...
        <section className="mt-14 space-y-4">
          ...
          <p className="text-[15px] leading-relaxed text-viscum-ink">
            シーダーは、作品を出して「ここを見てほしい」と書けます。反応がほしいときのコースは、次の4つです（同じ投稿では重ねません）。場内コンペ・公開ブーストは、広く撒いて刺さる声や外の反応を見つける祭り。直依頼は、この人の目が欲しいときの有償オファーです。
          </p>
          <ul className="list-disc space-y-3 pl-5 text-[15px] leading-relaxed text-viscum-ink">
            ...
            <li>
              ...
              … 「この人の目・言葉がピンポイントで欲しいとき」の、誠実な有償オファー。金額は関係やお願いの重さで決める（目安 ¥5,000〜¥50,000）。上のコース（広く撒く祭り）とは別もので、シードしたあとにできます。
            </li>
          </ul>
          <p className="text-[15px] leading-relaxed text-viscum-ink">
            場内と公開ブーストの価格は ¥0／¥5,000／¥10,000／¥30,000 だけです。直依頼は別レーンです。候補が集まるかどうかは、URLを広げられるかにもよります。足場の質問を用意したら、あとはメンターに書いてもらう番です。
          </p>
        </section>
